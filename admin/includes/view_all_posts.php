...
<form action="" method="post">
    <table class="table table-bordered table-hover">
        ...
        <div class="col-xs-4">
            <input onClick="javascript: return confirm('Click \'OK\' if you want to continue');" type="submit" name="submit" class="btn btn-success" value="Apply">
...
<?php 
    ...
    if (isset($_GET["reset"])) {
        ...
        //Query can be written also like this: "UPDATE posts SET post_views_count = 0 WHERE post_id =" . mysqli_real_escape_string($connection, $_GET['reset']) . " ";
